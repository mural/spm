...
public class SharedPreferencesUtils {
	...
	private static final String DEFAULT_NAME = AndroidApplication.get().getPackageName();
	...
	private static SharedPreferences getSharedPreferences(String name) {
		return AndroidApplication.get().getSharedPreferences(name, Context.MODE_PRIVATE);
	}
